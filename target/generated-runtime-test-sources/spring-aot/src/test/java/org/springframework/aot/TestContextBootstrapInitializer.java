...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.capgemini.MedicalStoreManagementSystemTests", () -> new AotSpringBootConfigContextLoader(MedicalStoreManagementSystemTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.capgemini.MedicalStoreManagementSystemTests", MedicalStoreManagementSystemTestsContextInitializer.class);
    return entries;
  }
}
