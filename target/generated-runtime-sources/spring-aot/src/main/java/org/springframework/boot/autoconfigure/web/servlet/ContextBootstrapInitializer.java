...
public final class ContextBootstrapInitializer {
  ...
  public static void registerWebMvcAutoConfiguration_ResourceChainCustomizerConfiguration(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("org.springframework.boot.autoconfigure.web.servlet.WebMvcAutoConfiguration$ResourceChainCustomizerConfiguration", WebMvcAutoConfiguration.ResourceChainCustomizerConfiguration.class)
        .instanceSupplier(WebMvcAutoConfiguration.ResourceChainCustomizerConfiguration::new).register(beanFactory);
  }

  public static void registerResourceChainCustomizerConfiguration_resourceHandlerRegistrationCustomizer(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("resourceHandlerRegistrationCustomizer", WebMvcAutoConfiguration.ResourceChainResourceHandlerRegistrationCustomizer.class).withFactoryMethod(WebMvcAutoConfiguration.ResourceChainCustomizerConfiguration.class, "resourceHandlerRegistrationCustomizer", WebProperties.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(WebMvcAutoConfiguration.ResourceChainCustomizerConfiguration.class).resourceHandlerRegistrationCustomizer(attributes.get(0)))).register(beanFactory);
  }
