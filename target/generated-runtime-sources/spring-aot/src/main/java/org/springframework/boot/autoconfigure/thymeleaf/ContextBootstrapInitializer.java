...
public final class ContextBootstrapInitializer {
  ...
  public static void registerThymeleafAutoConfiguration_ThymeleafSecurityDialectConfiguration(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("org.springframework.boot.autoconfigure.thymeleaf.ThymeleafAutoConfiguration$ThymeleafSecurityDialectConfiguration", ThymeleafAutoConfiguration.ThymeleafSecurityDialectConfiguration.class)
        .instanceSupplier(ThymeleafAutoConfiguration.ThymeleafSecurityDialectConfiguration::new).register(beanFactory);
  }

  public static void registerThymeleafSecurityDialectConfiguration_securityDialect(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("securityDialect", SpringSecurityDialect.class).withFactoryMethod(ThymeleafAutoConfiguration.ThymeleafSecurityDialectConfiguration.class, "securityDialect")
        .instanceSupplier(() -> beanFactory.getBean(ThymeleafAutoConfiguration.ThymeleafSecurityDialectConfiguration.class).securityDialect()).register(beanFactory);
  }
  ...
  public static void registerThymeleafWebMvcConfiguration_resourceUrlEncodingFilter(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("resourceUrlEncodingFilter", ResolvableType.forClassWithGenerics(FilterRegistrationBean.class, ResourceUrlEncodingFilter.class)).withFactoryMethod(ThymeleafAutoConfiguration.ThymeleafWebMvcConfiguration.class, "resourceUrlEncodingFilter")
        .instanceSupplier(() -> beanFactory.getBean(ThymeleafAutoConfiguration.ThymeleafWebMvcConfiguration.class).resourceUrlEncodingFilter()).register(beanFactory);
  }
